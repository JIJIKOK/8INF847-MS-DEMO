describe("Arithmetic", function () {
  describe("Validation", function () {
    ...
    it("rejects invalid operation", function (done) {
      request
        .get("/arithmetic?operation=foobar&operand1=21&operand2=21")
        .expect(400)
        .end(function (err, res) {
    ...
    it("rejects missing operand1", function (done) {
      request
        .get("/arithmetic?operation=add&operand2=21")
        .expect(400)
        .end(function (err, res) {
    ...
    it("rejects missing operand2", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=21")
        .expect(400)
        .end(function (err, res) {
    ...
    it("rejects operands with invalid sign", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=4.2-1&operand2=4")
        .expect(400)
        .end(function (err, res) {
  ...
  describe("Addition", function () {
    it("adds two positive integers", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=21&operand2=21")
        .expect(200)
        .end(function (err, res) {
    ...
    it("adds zero to an integer", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=42&operand2=0")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 42 });
          done();
    ...
    it("adds a negative integer to a positive integer", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=21&operand2=-42")
        .expect(200)
        .end(function (err, res) {
    ...
    it("adds an integer to a floating point number", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=2.5&operand2=-5")
        .expect(200)
        .end(function (err, res) {
    ...
    it("adds with negative exponent", function (done) {
      request
        .get("/arithmetic?operation=add&operand1=1.2e-5&operand2=-1.2e-5")
        .expect(200)
        .end(function (err, res) {
  ...
  describe("Subtraction", function () {
    it("subtracts two positive integers", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=42&operand2=21")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 21 });
          done();
    ...
    it("subtracts an integer from itself", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=42&operand2=42")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 0 });
          done();
    ...
    it("subtracts a larger integer from another", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=21&operand2=42")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: -21 });
          done();
    ...
    it("subtracts a negative integer from a positive integer", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=21&operand2=-21")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 42 });
          done();
  ...
  describe("Multiplication", function () {
    it("multiplies two positive integers", function (done) {
      request
        .get("/arithmetic?operation=multiply&operand1=21&operand2=2")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 42 });
          done();
    ...
    it("multiplies a positive integer with zero", function (done) {
      request
        .get("/arithmetic?operation=multiply&operand1=21&operand2=0")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 0 });
          done();
    ...
    it("multiplies two floating point numbers", function (done) {
      request
        .get("/arithmetic?operation=multiply&operand1=.5&operand2=0.5")
        .expect(200)
        .end(function (err, res) {
  ...
  describe("Division", function () {
    it("divides a positive integer by an integer factor ", function (done) {
      request
        .get("/arithmetic?operation=divide&operand1=42&operand2=2")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 21 });
          done();
    ...
    it("divides a positive integer by a non-factor", function (done) {
      request
        .get("/arithmetic?operation=divide&operand1=21&operand2=42")
        .expect(200)
        .end(function (err, res) {
    ...
    it("divides zero by a positive integer", function (done) {
      request
        .get("/arithmetic?operation=divide&operand1=0&operand2=42")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 0 });
          done();
    ...
    it("divides by zero", function (done) {
      request
        .get("/arithmetic?operation=divide&operand1=0.5&operand2=2")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 0.25 });
          done();
    ...
    it("divides by zero", function (done) {
      request
        .get("/arithmetic?operation=divide&operand1=21&operand2=0")
        .expect(200)
        .end(function (err, res) {
